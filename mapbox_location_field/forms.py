...
from .widgets import MapInput, AddressAutoHiddenInput, AddressCountry, AddressRegion, \
    AddressDistrict, AddressPlace, AddressLocality, AddressPostcode, AddressLine
